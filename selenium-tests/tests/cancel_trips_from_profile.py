...
class CancelTripsFromProfile:
    ...
    def cancel_trips(self):
        try:
            self.user.profile_view.cancel_trips_from_profile(driver=self.user.chrome_driver, num_items=self.num_products)
